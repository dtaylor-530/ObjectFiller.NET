...
namespace Tynamix.ObjectFiller
{
    ...
    public class FluentFillerApi
    {
        ...
        /// The object filler setup manager.
        /// </param>
        /// <param name="type">Type which will be configured for the object filler</param>
        internal FluentFillerApi(SetupManager setupManager, Type type)
        {
            this.setupManager = setupManager;
            Type = type;
        }
        ...
        /// <summary>
        /// Type which will be configured for the object filler
        /// </summary>
        ...
        /// </typeparam>
        /// <returns>
        /// <see cref="FluentTypeApi{TTargetType}"/>
        /// </returns>
        public FluentTypeApi<TTargetType> OnType<TTargetType>(Type type)
        {
            return new FluentTypeApi<TTargetType>(this, this.setupManager, type);
        }
        ...
        /// The <see cref="FluentCircularApi{TTargetObject}"/>.
        /// </returns>
        public FluentCircularApi OnCircularReference()
        {
            return new FluentCircularApi(this, this.setupManager, Type);
        }
        ...
        /// </param>
        /// <returns>
        /// The <see cref="FluentPropertyApi{TProperty}"/>.
        /// </returns>
        public FluentPropertyApi<TProperty> OnProperty<TProperty>(Expression<Func<object, TProperty>> property, params Expression<Func<object, TProperty>>[] additionalProperties)
        {
            var properties = new List<Expression<Func<object, TProperty>>> { property };
            ...
            var propInfos = new List<PropertyInfo>();
            foreach (Expression<Func<object, TProperty>> propertyExp in properties)
            {
                var body = propertyExp.Body as MemberExpression;
                if (body != null)
                {
            ...
            return new FluentPropertyApi<TProperty>(propInfos, this, this.setupManager, Type);
        }
        ...
        /// </param>
        /// <returns>
        /// The <see cref="FluentFillerApi"/>.
        /// </returns>
        public FluentFillerApi ListItemCount(int maxCount)
        {
            this.setupManager.GetFor(Type).ListMaxCount = maxCount;
            return this;
        }
        ...
        /// When you not call this method, the ObjectFiller raises an exception when it is not possible to generate a random value for that type!
        /// </summary>
        /// <returns>The <see cref="FluentFillerApi"/></returns>
        public FluentFillerApi IgnoreAllUnknownTypes()
        {
            this.setupManager.GetFor(Type).IgnoreAllUnknownTypes = true;
        ...
        /// </summary>
        /// <returns>The <see cref="FluentFillerApi{TTargetObject}"/></returns>
        public FluentFillerApi IgnoreInheritance()
        {
            this.setupManager.GetFor(Type).IgnoreInheritance = true;
        ...
        /// The <see cref="FluentFillerApi"/>
        /// </returns>
        public FluentFillerApi ListItemCount(int minCount, int maxCount)
        {
            this.setupManager.GetFor(Type).ListMinCount = minCount;
            this.setupManager.GetFor(Type).ListMaxCount = maxCount;
            return this;
        }
        ...
        /// The <see cref="FluentFillerApi"/>.
        /// </returns>
        public FluentFillerApi DictionaryItemCount(int maxCount)
        {
            this.setupManager.GetFor(Type).DictionaryKeyMaxCount = maxCount;
            return this;
        }
        ...
        /// The <see cref="FluentFillerApi{TTargetObject}"/>.
        /// </returns>
        public FluentFillerApi DictionaryItemCount(int minCount, int maxCount)
        {
            this.setupManager.GetFor(Type).DictionaryKeyMinCount = minCount;
            this.setupManager.GetFor(Type).DictionaryKeyMaxCount = maxCount;
            return this;
        }
        ...
        /// <param name="mocker">Mocker which will be used to mock interfaces</param>
        /// <returns>The <see cref="FluentFillerApi"/></returns>
        public FluentFillerApi SetInterfaceMocker(IInterfaceMocker mocker)
        {
            if (this.setupManager.GetFor(Type).InterfaceMocker != null)
            {
                const string Message = "You can not set a interface mocker more than once!";
                throw new ArgumentException(Message);
            }

            this.setupManager.GetFor(Type).InterfaceMocker = mocker;
            return this;
        }
