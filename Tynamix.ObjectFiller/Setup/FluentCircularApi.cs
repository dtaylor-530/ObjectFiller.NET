...
namespace Tynamix.ObjectFiller
{
    ...
    /// </summary>
    /// <typeparam name="TTargetObject">Type which will be configured for the object filler</typeparam>
    public class FluentCircularApi
    {
        /// <summary>
        /// The callback function
        /// </summary>
        ...
        /// The object filler setup manager.
        /// </param>
        internal FluentCircularApi(FluentFillerApi callback, SetupManager setupManager, Type type)
        {
            this.callback = callback;
            this.setupManager = setupManager;
            Type = type;
        ...
        /// The <see cref="FluentFillerApi{TTargetObject}"/>.
        /// </returns>
        public FluentFillerApi ThrowException(bool throwException = true)
        {
            this.setupManager.GetFor(Type).ThrowExceptionOnCircularReference = throwException;
